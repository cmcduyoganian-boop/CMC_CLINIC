    ...
    <div class="show-container">
        ...
        <div class="actions-card">
            ...
            <div class="actions-grid">
                <!-- Edit -->
                <a href="{{ route('users.edit', $user->id) }}" class="action-item edit">
                    <i class="fas fa-edit"></i>
                    <span>Edit User</span>
                </a>

                <!-- Reset Password -->
                <form method="POST" action="{{ route('users.reset-password', $user->id) }}" class="action-form" onsubmit="return confirm('Reset password for this user?');">
                    @csrf
                ...
                @if ($user->approval_status === 'pending')
                    <form method="POST" action="{{ route('users.approve', $user->id) }}" class="action-form">
                        @csrf
                    ...
                    <form method="POST" action="{{ route('users.reject', $user->id) }}" class="action-form" onsubmit="return confirm('Reject this account?');">
                        @csrf
                ...
                @if ($user->approval_status === 'approved' && auth()->id() !== $user->id)
                    <form method="POST" action="{{ route('users.disable', $user->id) }}" class="action-form" onsubmit="return confirm('Disable this account?');">
                        @csrf
                ...
                <!-- Delete -->
                @if (auth()->id() !== $user->id)
                    <form method="POST" action="{{ route('users.destroy', $user->id) }}" class="action-form" onsubmit="return confirm('Delete this user? This action cannot be undone.');">
                        @csrf
                        @method('DELETE')
