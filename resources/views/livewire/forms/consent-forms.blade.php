        ...
        <div class="drawer-header">
            <h2>
                @if($activeForm === 'client')
                    📋 Client Consent Form
                @elseif($activeForm === 'research')
                    🔬 Research Consent Form
                @elseif($activeForm === 'medical')
                    🏥 Medical History Form
                @endif
            </h2>
                ...
                <form wire:submit="submitClientConsent">
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            @error('fullName')<span class="error-text">{{ $message }}</span>@enderror
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                @error('dateOfBirth')<span class="error-text">{{ $message }}</span>@enderror
                            </div>
                            <div class="form-group">
                    ...
                    <div class="form-section">
                        ...
                        @error('consentAgreed')<span class="error-text">{{ $message }}</span>@enderror
                    </div>
                ...
                <form wire:submit="submitResearchConsent">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            @error('studentName')<span class="error-text">{{ $message }}</span>@enderror
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                @error('studentId')<span class="error-text">{{ $message }}</span>@enderror
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        @error('researchConsent')<span class="error-text">{{ $message }}</span>@enderror
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                @error('sex')<span class="error-text">{{ $message }}</span>@enderror
                            </div>
                            <div class="form-group">
                                <label>Date of Birth *</label>
                                <input type="date" wire:model="birthDate" class="form-input">
                                @error('birthDate')<span class="error-text">{{ $message }}</span>@enderror
                            </div>
                        </div>
