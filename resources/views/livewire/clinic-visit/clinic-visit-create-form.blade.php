    ...
    <form wire:submit="save" class="clinic-visit-form">
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                >
                    ...
                    <div class="ms-panel" x-show="open" x-transition>
                        ...
                        {{-- "Other" text input inside dropdown --}}
            ...
            <div class="form-row-3">
                ...
                <div class="form-group">
                    <label class="form-label">{{ in_array($patientCategory, ['faculty', 'staff']) ? 'Department' : 'Program' }}</label>
                    <input type="text" wire:model="patientProgram" class="form-control"
                           placeholder="{{ in_array($patientCategory, ['faculty', 'staff']) ? 'Enter department' : 'Enter program' }}">
                </div>
        ...
        <div class="form-actions">
            <a href="{{ route('clinic-visit.index') }}" class="btn btn-cancel" onclick="return confirm('Discard changes?')">
