<div class="clinic-visit-form-page">
    ...
    <div class="form-header">
        ...
        <div class="patient-info-banner">
            ...
            @if($visit->patient->program)
                <p><strong>Program:</strong> {{ $visit->patient->program }}</p>
            @endif
            @if($visit->patient->year_section)
                <p><strong>Year &amp; Section:</strong> {{ $visit->patient->year_section }}</p>
            @endif
        </div>
    </div>
    ...
    <form wire:submit="save" class="clinic-visit-form">
            ...
            <div class="vitals-grid">
                ...
                <div class="form-group">
                    ...
                    <div class="bmi-display">
                        @if ($this->bmi !== null)
                            <span class="bmi-value">{{ $this->bmi }}</span>
                            <span class="bmi-badge {{ $this->bmiCategory['class'] }}">{{ $this->bmiCategory['label'] }}</span>
                        @else
        ...
        <div class="form-actions">
            <a href="{{ route('clinic-visit.index') }}" class="btn btn-cancel">
                <i class="fas fa-times"></i> Cancel
            </a>
            <a href="{{ route('clinic-visit.show', $visit->id) }}" class="btn btn-secondary">
