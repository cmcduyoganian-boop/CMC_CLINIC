            ...
            <div class="settings-content">
                ...
                <div id="password-section" class="settings-section">
                    <div class="section-card">
                        ...
                        <!-- Step 1: Request OTP -->
                        @if (!session('step') || session('step') !== 'verify_otp')
                            <form action="{{ route('settings.password.request-otp') }}" method="POST" class="settings-form">
                                @csrf
