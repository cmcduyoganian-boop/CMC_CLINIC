<div class="users-container">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($flashMessage): ?>
        <div class="alert alert-<?php echo e($flashType === 'danger' ? 'error' : 'success'); ?>">
            <i class="fas fa-<?php echo e($flashType === 'danger' ? 'exclamation-circle' : 'check-circle'); ?>"></i>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showPasswordResult): ?>
        <div class="alert alert-success" style="flex-direction:column;align-items:flex-start;gap:8px;">
            <strong><i class="fas fa-key"></i> New password for <?php echo e($resultUsername); ?>:</strong>
            <div style="background:white;padding:10px 14px;border-radius:6px;font-family:monospace;font-size:15px;font-weight:700;letter-spacing:1px;">
                <?php echo e($resultPassword); ?>

            </div>
            <small>Share this password securely with <?php echo e($resultEmail); ?>. They will be asked to change it on next login.</small>
        </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    <!-- STATS CARDS -->
    <div class="stats-grid">
        <button type="button" wire:click="$set('statusFilter', '')" class="stat-card <?php echo e($statusFilter === '' ? 'active' : ''); ?>" style="border:none;text-align:left;width:100%;cursor:pointer;">
        ...
        <button type="button" wire:click="$set('statusFilter', 'pending')" class="stat-card <?php echo e($statusFilter === 'pending' ? 'active' : ''); ?>" style="border:none;text-align:left;width:100%;cursor:pointer;">
        ...
        <button type="button" wire:click="$set('statusFilter', 'approved')" class="stat-card <?php echo e($statusFilter === 'approved' ? 'active' : ''); ?>" style="border:none;text-align:left;width:100%;cursor:pointer;">
        ...
        <button type="button" wire:click="$set('statusFilter', 'disabled')" class="stat-card <?php echo e($statusFilter === 'disabled' ? 'active' : ''); ?>" style="border:none;text-align:left;width:100%;cursor:pointer;">
            <div class="stat-icon disabled">
                <i class="fas fa-ban"></i>
            </div>
            <div class="stat-content">
                <div class="stat-value"><?php echo e($stats['disabled'] ?? 0); ?></div>
    ...
    <div class="role-breakdown">
        ...
        <div class="breakdown-grid">
            <div class="breakdown-item">
                <span class="badge badge-blue"><?php echo e($stats['students'] ?? 0); ?></span>
                Students
            </div>
            <div class="breakdown-item">
                <span class="badge badge-green"><?php echo e($stats['faculty'] ?? 0); ?></span>
                Faculty
            </div>
            <div class="breakdown-item">
                <span class="badge badge-orange"><?php echo e($stats['staff'] ?? 0); ?></span>
                Staff
            </div>
            <div class="breakdown-item">
                <span class="badge badge-purple"><?php echo e($stats['clinic_nurse'] ?? 0); ?></span>
                Clinic Nurses
            </div>
            <div class="breakdown-item">
                <span class="badge badge-red"><?php echo e($stats['clinic_staff'] ?? 0); ?></span>
                Clinic Staff
            </div>
        </div>
    </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendingRegistrations->isNotEmpty() && (!$statusFilter || $statusFilter === 'pending')): ?>
                            ...
                            <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'pending-registration-'.e($pending->id).''; ?>wire:key="pending-registration-<?php echo e($pending->id); ?>">
                                ...
                                <td>
                                    <button type="button" class="btn-action reject" title="Deny"
                                            ...
                                            wire:confirm="Deny <?php echo e($pending->name); ?>'s registration?">
                        ...
                        <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'user-'.e($user->id).''; ?>wire:key="user-<?php echo e($user->id); ?>">
                            ...
                            <td>
                                <div class="action-buttons">
                                    <!-- View -->
                                    <a href="<?php echo e(route('users.show', $user->id)); ?>" class="btn-action" title="View">
                                        <i class="fas fa-eye"></i>
                                    </a>

                                    <!-- Edit -->
                                    <a href="<?php echo e(route('users.edit', $user->id)); ?>" class="btn-action" title="Edit">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->approval_status === 'pending'): ?>
                                        <button type="button" class="btn-action approve" title="Confirm"
                                            ...
                                            wire:confirm="Approve <?php echo e($user->name); ?>'s account?">
                                            <i class="fas fa-check"></i>
                                        </button>

                                        <button type="button" class="btn-action reject" title="Deny"
                                            wire:click="rejectUser(<?php echo e($user->id); ?>)"
                                            wire:confirm="Reject <?php echo e($user->name); ?>'s account?">
                                            <i class="fas fa-times"></i>
                                        </button>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->approval_status === 'approved' && auth()->id() !== $user->id): ?>
                                        <button type="button" class="btn-action disable" title="Disable"
                                            ...
                                            wire:confirm="Disable <?php echo e($user->name); ?>'s account?">
                                    ...
                                    <button type="button" class="btn-action reset" title="Reset Password"
                                        wire:click="resetPasswordFor(<?php echo e($user->id); ?>)"
                                        wire:confirm="Reset password for <?php echo e($user->name); ?>?">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->id() !== $user->id): ?>
                                        <button type="button" class="btn-action delete" title="Delete"
                                            ...
                                            wire:confirm="Delete <?php echo e($user->name); ?>? This cannot be undone.">
...
</style><?php /**PATH C:\laragon\www\cmc_clinic\resources\views/livewire/users/user-management-list.blade.php ENDPATH**/ ?>