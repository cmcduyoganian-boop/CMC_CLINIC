...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('header', null, []); ?> Patient Report <?php $__env->endSlot(); ?>
    ...
    <div class="report-page">
        ...
        <div class="summary-cards">
            <div class="card">
                ...
                <p class="card-value"><?php echo e($totalPatients); ?></p>
            </div>
            <div class="card">
                <h3>Students</h3>
                <p class="card-value"><?php echo e($students); ?></p>
            </div>
            <div class="card">
                <h3>Faculty</h3>
                <p class="card-value"><?php echo e($faculty); ?></p>
            </div>
            <div class="card">
                <h3>Staff</h3>
                <p class="card-value"><?php echo e($staff); ?></p>
            </div>
        </div>
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr>
                                ...
                                <td><strong><?php echo e($patient->name); ?></strong></td>
                                <td>
                                ...
                                <td><?php echo e($patient->clinic_visits_count); ?></td>
                                <td>
    ...
    <script>
        ...
        new Chart(categoryCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [<?php echo e($students); ?>, <?php echo e($faculty); ?>, <?php echo e($staff); ?>],
        ...
        new Chart(statusCtx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Patients',
                    data: [<?php echo e($activePatients); ?>, <?php echo e($inactivePatients); ?>],
...
<?php endif; ?><?php /**PATH C:\laragon\www\cmc_clinic\resources\views\reports\patients.blade.php ENDPATH**/ ?>