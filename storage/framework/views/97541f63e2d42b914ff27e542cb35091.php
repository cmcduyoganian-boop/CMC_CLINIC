...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="edit-container">
        ...
        <div class="edit-card">
            ...
            <form method="POST" action="<?php echo e(route('users.update', $user->id)); ?>" class="edit-form">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        >
                            ...
                            <option value="clinic_nurse" <?php echo e($user->role === 'clinic_nurse' ? 'selected' : ''); ?>>Clinic Nurse</option>
                            <option value="clinic_staff" <?php echo e($user->role === 'clinic_staff' ? 'selected' : ''); ?>>Clinic Staff</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select 
                            ...
                            class="form-input <?php $__errorArgs = ['approval_status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            required
                        >
                            <option value="approved" <?php echo e($user->approval_status === 'approved' ? 'selected' : ''); ?>>Approved</option>
                            <option value="pending" <?php echo e($user->approval_status === 'pending' ? 'selected' : ''); ?>>Pending</option>
                            <option value="disabled" <?php echo e($user->approval_status === 'disabled' ? 'selected' : ''); ?>>Disabled</option>
                            <option value="rejected" <?php echo e($user->approval_status === 'rejected' ? 'selected' : ''); ?>>Rejected</option>
                        </select>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input 
                                ...
                                name="clinic_name" 
                                class="form-input"
                                value="<?php echo e(old('clinic_name', $user->clinic_name)); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <input 
                                ...
                                name="clinic_phone" 
                                class="form-input"
                                value="<?php echo e(old('clinic_phone', $user->clinic_phone)); ?>"
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input 
                                ...
                                name="clinic_address" 
                                class="form-input"
                                value="<?php echo e(old('clinic_address', $user->clinic_address)); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <input 
                                ...
                                name="clinic_hours" 
                                class="form-input"
                                value="<?php echo e(old('clinic_hours', $user->clinic_hours)); ?>"
...
<?php endif; ?><?php /**PATH C:\laragon\www\cmc_clinic\resources\views\users\edit.blade.php ENDPATH**/ ?>