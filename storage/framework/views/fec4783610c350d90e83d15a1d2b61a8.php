<div class="clinic-visit-form-page">
    ...
    <div class="form-header">
        ...
        <p class="form-description">Update patient information</p>
    </div>
    ...
    <form wire:submit="save" class="clinic-visit-form">
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn btn-save" wire:loading.attr="disabled" wire:target="save">
                                <span wire:loading.remove wire:target="save"><i class="fas fa-save"></i> Update Patient</span>
...
</style><?php /**PATH C:\laragon\www\cmc_clinic\resources\views\livewire\patients\patient-edit-form.blade.php ENDPATH**/ ?>