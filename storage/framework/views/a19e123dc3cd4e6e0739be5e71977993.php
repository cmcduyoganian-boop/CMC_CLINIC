<div class="appointments-page">
    ...
    <div class="page-header">
        ...
        <a href="<?php echo e(route('appointments.create')); ?>" class="btn-new-appointment">
    ...
    <div class="status-cards">
        <div class="card upcoming">
            ...
            <div class="card-info">
                <h3>Upcoming</h3>
                <p class="card-value"><?php echo e($upcoming); ?></p>
            </div>
        </div>
        ...
        <div class="card total">
            ...
            <div class="card-info">
                <h3>Total</h3>
                <p class="card-value"><?php echo e($total); ?></p>
            </div>
        </div>
    </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($appointments->isEmpty()): ?>
            <div class="empty-state">
                ...
                <?php else: ?>
                    ...
                    <a href="<?php echo e(route('appointments.create')); ?>" class="btn-empty">
            ...
            <table class="appointments-table">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="appointment-row <?php echo e($appointment->isUpcoming() ? 'upcoming' : ''); ?>" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'appointment-'.e($appointment->id).''; ?>wire:key="appointment-<?php echo e($appointment->id); ?>">
                            <td class="date-time">
                            ...
                            <td class="patient-name"><?php echo e($appointment->patient->name); ?></td>
                            <td>
                            ...
                            <td class="reason"><?php echo e($appointment->reason ?? '-'); ?></td>
                            <td>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="<?php echo e(route('appointments.show', $appointment->id)); ?>" class="btn-view" title="View">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="<?php echo e(route('appointments.edit', $appointment->id)); ?>" class="btn-edit" title="Edit">
                                    ...
                                    <button
                                        ...
                                        class="btn-delete"
                                        title="Delete"
                                        wire:click="deleteAppointment(<?php echo e($appointment->id); ?>)"
                                        wire:confirm="Delete this appointment for <?php echo e($appointment->patient->name); ?>? This cannot be undone."
                                    >
...
</style><?php /**PATH C:\laragon\www\cmc_clinic\resources\views\livewire\appointments\appointment-list.blade.php ENDPATH**/ ?>