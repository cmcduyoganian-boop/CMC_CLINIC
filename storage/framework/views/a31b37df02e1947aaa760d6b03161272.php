<div class="clinic-visit-form-page">
    ...
    <div class="form-header">
        <h1 class="form-title">Edit Clinic Visit</h1>
        <p class="form-description">Update patient visit information and vital signs</p>
        <div class="patient-info-banner">
            <p class="patient-name-display">
                <strong>Patient:</strong> <?php echo e($visit->patient->name); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($visit->patient->program): ?>
                <p><strong>Program:</strong> <?php echo e($visit->patient->program); ?></p>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($visit->patient->year_section): ?>
                <p><strong>Year &amp; Section:</strong> <?php echo e($visit->patient->year_section); ?></p>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
    ...
    <form wire:submit="save" class="clinic-visit-form">
        ...
        <div class="form-actions">
            <a href="<?php echo e(route('clinic-visit.index')); ?>" class="btn btn-cancel">
                <i class="fas fa-times"></i> Cancel
            </a>
            <a href="<?php echo e(route('clinic-visit.show', $visit->id)); ?>" class="btn btn-secondary">
                <i class="fas fa-eye"></i> View Details
            </a>
            <button type="submit" class="btn btn-save" wire:loading.attr="disabled" wire:target="save">
                <span wire:loading.remove wire:target="save"><i class="fas fa-save"></i> Update Visit</span>
...
</style><?php /**PATH C:\laragon\www\cmc_clinic\resources\views\livewire\clinic-visit\clinic-visit-edit-form.blade.php ENDPATH**/ ?>