<div class="clinic-visit-form-page">
    ...
    <div class="form-header">
        ...
        <p class="form-description">Update medicine information</p>
    </div>
        ...
        <div class="form-section">
            ...
            <div class="form-row-2">
                <div class="form-group">
                    ...
                    <input type="text" wire:model="unit" class="form-control" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="readonly-display">
                        ...
                        <small>Use "Use Stock" / "Add Stock" on the inventory page to change this</small>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" wire:model="storageLocation" class="form-control">
            </div>
        </div>

        <!-- Action Buttons -->
        <div class="form-actions">
            <a href="<?php echo e(route('medicines.index')); ?>" class="btn btn-cancel">
                <i class="fas fa-times"></i> Cancel
            </a>
            <button type="submit" class="btn btn-save" wire:loading.attr="disabled" wire:target="save">
                <span wire:loading.remove wire:target="save"><i class="fas fa-save"></i> Update Medicine</span>
...
<?php /**PATH C:\laragon\www\cmc_clinic\resources\views\livewire\inventory\medicine-edit-form.blade.php ENDPATH**/ ?>