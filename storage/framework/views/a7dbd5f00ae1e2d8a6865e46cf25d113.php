...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('header', null, []); ?> Edit Patient <?php $__env->endSlot(); ?>

    <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('patients.patient-edit-form', ['patient-id' => $patientId]);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3801769034-0', $__key);
...
<?php endif; ?><?php /**PATH C:\laragon\www\cmc_clinic\resources\views/patients/edit.blade.php ENDPATH**/ ?>