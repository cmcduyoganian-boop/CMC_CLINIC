...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('header', null, []); ?> Edit Medicine <?php $__env->endSlot(); ?>

    <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('inventory.medicine-edit-form', ['medicine-id' => $medicineId]);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-4106245825-0', $__key);
...
<?php endif; ?><?php /**PATH C:\laragon\www\cmc_clinic\resources\views\inventory\medicines-edit.blade.php ENDPATH**/ ?>