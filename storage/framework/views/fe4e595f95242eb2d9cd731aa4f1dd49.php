        ...
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box;}
        ...
        body{
            ...
            background:
                ...
                url("<?php echo e(asset('images/cmc_background.jpg')); ?>") center center / cover no-repeat fixed;
            color:var(--text-body);
            line-height:1.6;
            overflow-x:hidden;
        }
...
<nav id="mainNav">
    <div class="navbar">
        ...
        <div class="nav-actions">
            <a href="<?php echo e(route('login')); ?>" class="btn-ghost"><i class="fas fa-sign-in-alt"></i> Login</a>
            <a href="<?php echo e(route('login')); ?>" class="btn-nav-cta">Clinic Portal <i class="fas fa-arrow-right"></i></a>
        </div>
...
<div class="mobile-menu" id="mobileMenu">
    ...
    <a href="<?php echo e(route('login')); ?>" style="color:#38bdf8;font-weight:700;border-bottom:none;"><i class="fas fa-sign-in-alt"></i> Access Clinic Portal</a>
</div>
<section class="hero" id="home">
    <div class="hero-inner hero-centered">
        ...
        <div class="hero-btns hero-btns-centered">
            <a href="<?php echo e(route('login')); ?>" class="btn-hero-primary"><i class="fas fa-sign-in-alt"></i> Access Clinic Portal</a>
...
<div class="stats-band" id="about">
    <div class="section-wrap">
        <div class="stats-grid">
            <div class="stat-item reveal"><div class="stat-num" data-count="<?php echo e($stats['patients']); ?>" data-suffix="+">0+</div><div class="stat-lbl">Patients Served</div></div>
            <div class="stat-item reveal reveal-d1"><div class="stat-num" data-count="<?php echo e($stats['visits']); ?>" data-suffix="">0</div><div class="stat-lbl">Clinic Visits</div></div>
            <div class="stat-item reveal reveal-d2"><div class="stat-num" data-count="<?php echo e($stats['staff']); ?>" data-suffix="">0</div><div class="stat-lbl">Active Staff</div></div>
            <div class="stat-item reveal reveal-d3"><div class="stat-num" data-count="<?php echo e($stats['users']); ?>" data-suffix="+">0+</div><div class="stat-lbl">Registered Users</div></div>
        </div>
...
<section class="cta-section" id="contact">
    <div class="cta-inner">
        ...
        <div class="cta-btns">
            <a href="<?php echo e(route('login')); ?>" class="btn-cta-main"><i class="fas fa-sign-in-alt"></i> Access Clinic Portal</a>
...
<footer>
    <div class="footer-grid">
        ...
        <div>
            <h5>Quick Access</h5>
            <ul><li><a href="<?php echo e(route('login')); ?>">Login</a></li><li><a href="<?php echo e(route('register')); ?>">Register</a></li><li><a href="<?php echo e(route('register.clinic-staff')); ?>">Staff Registration</a></li></ul>
        </div>
...
<?php /**PATH C:\laragon\www\cmc_clinic\resources\views/landing.blade.php ENDPATH**/ ?>