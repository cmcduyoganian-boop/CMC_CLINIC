        ...
        <div class="table-container">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($visits->isEmpty()): ?>
                <div class="empty-state">
                    ...
                    <a href="<?php echo e(route('clinic-visit.create')); ?>" class="btn-empty">
                        Record First Visit
                    </a>
                </div>
            <?php else: ?>
                <table class="visits-table">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $visits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $visit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr class="visit-row">
                                <td><?php echo e($visit->visit_date ? date('m/d/Y', strtotime($visit->visit_date)) : '-'); ?></td>
                                <td class="patient-name"><?php echo e($visit->patient->name); ?></td>
                                <td>
                                ...
                                <td class="year-section"><?php echo e($visit->patient->year_section ?? '-'); ?></td>
                                <td class="text-small"><?php echo e(Str::limit($visit->complaints, 40)); ?></td>
                                <td class="text-small"><?php echo e(Str::limit($visit->diagnosis, 40)); ?></td>
                                <td>
