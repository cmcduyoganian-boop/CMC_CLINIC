<div class="dashboard-wrapper" wire:poll-30000ms>
    ...
    <div class="kpi-section">
        ...
        <div class="kpi-card">
            ...
            <div class="kpi-value"><?php echo e($totalPatients); ?></div>
        ...
        <div class="kpi-card" onclick="navigateToVisits()">
            ...
            <div class="kpi-value"><?php echo e($vitalSignsOverview['abnormal']); ?></div>
    ...
    <div class="main-grid">
        ...
        <div class="activities-section">
            <div class="activities-card">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($recentActivities) > 0): ?>
                    <a href="<?php echo e(route('clinic-visit.index')); ?>" class="view-all">View Visit Records →</a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
    </div>
    ...
    <div class="quick-actions-section">
        ...
        <div class="quick-actions-grid">
            ...
            <a href="<?php echo e(route('clinic-visit.index')); ?>" class="action-btn">
                <i class="fas fa-notes-medical"></i> Visit Records
            </a>
            <a href="<?php echo e(route('medicines.index')); ?>" class="action-btn">
...
<?php /**PATH C:\laragon\www\cmc_clinic\resources\views/livewire/dashboard/clinic-staff-dashboard.blade.php ENDPATH**/ ?>