    ...
    <div class="verify-card">
        ...
        <div class="verify-header">
            ...
            <p class="verify-subtitle">
                We've sent a 6-digit verification code to <span class="verify-email"><?php echo e($pending->email); ?></span>
            </p>
        </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->has('otp')): ?>
            <div class="alert alert-error">
        ...
        <!-- OTP Form -->
        <form method="POST" action="<?php echo e(route('otp.verify', $pending->email)); ?>" id="otpForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="resend-section">
                ...
                <form method="POST" action="<?php echo e(route('otp.resend')); ?>" style="display: inline;">
                    <?php echo csrf_field(); ?>
            ...
            <!-- Back Link -->
            <div class="back-link">
                <a href="<?php echo e(route('register')); ?>">← Back to registration</a>
            </div>
    </div>
...
</html><?php /**PATH C:\laragon\www\cmc_clinic\resources\views/auth/verify-otp.blade.php ENDPATH**/ ?>