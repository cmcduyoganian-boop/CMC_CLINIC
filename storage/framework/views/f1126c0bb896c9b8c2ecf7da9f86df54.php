...
unset($__errorArgs, $__bag); ?>"
                        ...
                        >
                            ...
                            <option value="clinic_nurse" <?php echo e(old('role') === 'clinic_nurse' ? 'selected' : ''); ?>>Clinic Nurse</option>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="form-group" id="yearSectionGroup" style="display: none;">
                        ...
                        <input 
                            ...
                            name="year_section" 
                            class="form-input"
                            value="<?php echo e(old('year_section')); ?>"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('show_password') && session('show_password') === true): ?>
                ...
                <div class="modal-content">
                    <div class="credential-item">
                        ...
                        <div class="credential-value">
                            <?php echo e(session('default_name')); ?>
                    ...
                    <div class="credential-item">
                        ...
                        <div class="credential-value copy-group">
                            <span id="usernameValue"><?php echo e(session('default_username')); ?></span>
                    ...
                    <div class="credential-item">
                        ...
                        <div class="credential-value copy-group">
                            <span id="passwordValue" class="password-text"><?php echo e(session('default_password')); ?></span>
                    ...
                    <div class="credential-item">
                        <label>Role</label>
                        <div class="credential-value">
                            <?php echo e(session('default_role')); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\cmc_clinic\resources\views\users\create.blade.php ENDPATH**/ ?>