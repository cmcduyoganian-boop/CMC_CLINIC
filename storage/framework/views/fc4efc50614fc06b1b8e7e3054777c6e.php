...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('header', null, []); ?> User Management <?php $__env->endSlot(); ?>

    <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('users.user-management-list', []);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3337867700-0', $__key);
...
<?php endif; ?><?php /**PATH C:\laragon\www\cmc_clinic\resources\views/users/index.blade.php ENDPATH**/ ?>