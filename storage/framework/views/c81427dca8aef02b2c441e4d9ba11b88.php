...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('header', null, []); ?> Medicine History <?php $__env->endSlot(); ?>

    <div class="history-page">
        <!-- Header -->
        <div class="page-header">
            <div class="header-left">
                <h1 class="page-title"><?php echo e($medicine->name); ?></h1>
                <p class="page-subtitle">Inventory History</p>
                <div class="medicine-info-badges">
                    <span class="badge <?php echo e($medicine->getStatusBadgeClass()); ?>">
                        <?php echo e($medicine->getStatusLabel()); ?>

                    </span>
                    <span class="info-badge">Current Stock: <?php echo e($medicine->quantity); ?> <?php echo e($medicine->unit); ?></span>
                </div>
            </div>
            <a href="<?php echo e(route('medicines.index')); ?>" class="btn-back">
        ...
        <div class="summary-card">
            <div class="summary-item">
                ...
                <span class="summary-value"><?php echo e($medicine->quantity); ?></span>
                <span class="summary-unit"><?php echo e($medicine->unit); ?></span>
            </div>
            <div class="summary-item">
                <span class="summary-label">Minimum Stock</span>
                <span class="summary-value"><?php echo e($medicine->minimum_stock); ?></span>
                <span class="summary-unit"><?php echo e($medicine->unit); ?></span>
            </div>
            <div class="summary-item">
                <span class="summary-label">Storage Location</span>
                <span class="summary-value"><?php echo e($medicine->storage_location ?? 'Not Set'); ?></span>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($medicine->expiration_date): ?>
                <div class="summary-item">
                    ...
                    <span class="summary-value <?php echo e($medicine->isExpired() ? 'expired' : ''); ?>">
                ...
                <table class="history-table">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr class="log-row action-<?php echo e($log->action); ?>">
                                <td class="date-time">
                                    <?php echo e($log->created_at->format('M d, Y')); ?><br>
                                    <small><?php echo e($log->created_at->format('H:i A')); ?></small>
                                </td>
                                <td>
                                    <span class="action-badge badge-<?php echo e($log->action); ?>">
                                        <?php echo e(ucfirst($log->action)); ?>

                                    </span>
                                </td>
                                <td class="quantity">
                                    <span class="qty-value <?php echo e(in_array($log->action, ['received', 'adjusted']) ? 'positive' : 'negative'); ?>">
                                        <?php echo e(in_array($log->action, ['received', 'adjusted']) ? '+' : '-'); ?><?php echo e($log->quantity); ?>
        ...
        <div class="page-actions">
            <a href="<?php echo e(route('medicines.edit', $medicine->id)); ?>" class="btn btn-edit">
                <i class="fas fa-edit"></i> Edit Medicine
            </a>
            <a href="<?php echo e(route('medicines.index')); ?>" class="btn btn-back-full">
...
<?php endif; ?><?php /**PATH C:\laragon\www\cmc_clinic\resources\views\inventory\medicines-history.blade.php ENDPATH**/ ?>